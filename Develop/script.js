...
const collectEmployees = function() {
  ...
  while (addEmployees) {
    ...
    employees.salary = salary.toLocaleString('en-US', { style: 'currency', currency: 'USD' });
...
const getRandomEmployee = function(employeesArray) {
  // TODO: Select and display a random employee
   const luckyWinner = Math.floor(Math.random() * employeesArray.length);
   const randomEmployee = employeesArray[luckyWinner];

   console.log(`Congratulations ${randomEmployee.firstName} ${randomEmployee.lastName}, you are the winner!`);
}
